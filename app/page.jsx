      ...
      <section className="min-h-dvh bg-black/40 flex items-center justify-center">
        <div className="space-y-10 md:max-w-4xl p-3">
          ...
          <p className="md:text-2xl text-lg font-light">
            <span className="text-orange-300 font-semibold">ScholarNote</span> is a modern research hub designed for origanizing, sharing and discovering knowledge in one place. It allows researchers as well as students to create structured notes, connect ideas, collaborate with others and turn scattered research into clear usable insignts.
          </p>
