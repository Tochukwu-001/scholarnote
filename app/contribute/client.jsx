...
const Client = (session) => {
  ...
  return (
    <main className='min-h-dvh'>
      <h1 className='md:max-w-2xl text-center text-2xl md:text-3xl text-gray-700
          ...
          resetForm();
            ...
            <Form className='space-y-3 shadow-lg rounded-md p-3'>
                ...
                <div>
                    ...
                    <Field name="note" as="textarea" rows="10"  placeholder= "Enter Research Note " className="w-full border
                    outline-none px-3 py-2 border-gray-300 rounded-md"/>
                     <ErrorMessage name='note' component={"p"} className='text-sm text-red-500 mt-2'/>
                </div>
                <button type='submit' className='bg-orange-600 w-full flex items-center justify-center text-white p-3 rounded-md
                gap-2 font-semibold hover:bg-orange-700 transition-all duration-200'>
                  upload research 
                   <FaPaperPlane />
                </button>
            </Form>
