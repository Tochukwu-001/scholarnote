        ...
        <Formik initialValues={iv} validationSchema={formValidation}
          ...
          <Form className='space-y-5 shadow-lg rounded-md p-6'>
            ...
            <div>
              ...
              <Field name="note" as="textarea" placeholder="Enter Research Note..." rows="10" className="w-full border outline-none px-3 py-2 border-gray-300 rounded-md" />
              <ErrorMessage name='note' component={"p"} className='text-sm text-red-500 mt-2' />
            </div>
            <button type='submit' className='bg-orange-600 w-full flex items-center justify-center 
                text-white p-3 rounded-md gap-2 font-semibold hover:bg-orange-700 transition-all 
                duration-200'>
              Upload Research
              <FaPaperPlane />
            </button>
